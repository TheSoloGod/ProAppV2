...
export default function RegisterScreen() {
    ...
    const [is_send_otp, setIsSendOtp] = useState(false);
    ...
    return (
        <SafeAreaView style={{
                    ...
                    }
                    {
                        is_send_otp
                            ...
                            <Button
                                ...
                                onPress={() => {navigation.navigate(navigationName.mainStack.TAB_BOTTOM)}}
                            />
                            :
                            <Button
                                title="ĐĂNG NHẬP"
            ...
            <TouchableOpacity style={{
                ...
                navigation.navigate(navigationName.mainStack.TAB_BOTTOM)
            }}>
                <Text style={{
                    color: 'gray',
